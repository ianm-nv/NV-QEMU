...
static const char *const TpmLogDigestAlgo_str[] = {
    [TPM_LOG_DIGEST_ALGO_SHA256] = "sha256",
    [TPM_LOG_DIGEST_ALGO_SHA512] = "sha512",
};

const QEnumLookup TpmLogDigestAlgo_lookup = {
    .array = TpmLogDigestAlgo_str,
    .size = TPM_LOG_DIGEST_ALGO__MAX,
};
